...
// Fusionne { questions, rules } dans _configBuilderState (append, sans
// écraser l'existant) — partagé par l'import JSON et l'import texte (DSL).
function _configMergeQuestionsRules(data){
  var existingIds = {};
...
function _configRulesImportFile(file){
  ...
  reader.onload = function(){
    ...
    _configMergeQuestionsRules(data);
  };
